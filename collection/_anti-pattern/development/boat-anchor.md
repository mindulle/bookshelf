...
A sales practice called \"very important person (VIP) marketing\"
targets the sales pitch at senior decision makers who have buying
authority. VIP marketing often focuses on chief executive officers of
small- to medium-size corporations. A commitment to the product is made
without proper technical evaluation.

<figure class="image">
<img src="/files/sm/images/anchor.jpg"
srcset="/files/sm/images/anchor.jpg?id=cfbdc3748b1e2e35f0e31da6c23ed401 2x"
width="345" />
</figure>
...
[Golden Hammer []{.fa
.fa-arrow-right}](/antipatterns/golden-hammer){.btn .btn-primary
rel="next"}
...
[[]{.fa .fa-arrow-left} Poltergeists](/antipatterns/poltergeists){.btn
