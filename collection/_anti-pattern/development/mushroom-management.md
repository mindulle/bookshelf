...
# Mushroom Management {#mushroom-management .title}




Also known as Pseudo-Analysis and Blind Development, Mushroom Management
is often described by this phrase: \"Keep your developers in the dark
and feed them fertilizer.\"
...
participation, \"The risk is that you end up building the wrong
system.\"

<figure class="image">
<img src="/files/sm/images/dev.jpg"
srcset="/files/sm/images/dev.jpg?id=07ed0d76a818e2c107081e9f61a576b1 2x"
width="300" />
</figure>
...
[Software Architecture AntiPatterns []{.fa
.fa-arrow-right}](/antipatterns/software-architecture-antipatterns){.btn
...
[[]{.fa .fa-arrow-left} Cut-And-Paste
Programming](/antipatterns/cut-and-paste-programming){.btn .btn-default
rel="prev"}
