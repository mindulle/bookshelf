...
![Design Patterns in
C++](/images/patterns/languages/cpp.png?id=57a67e9dfa3521c9dfc32d72201292cb){.dp-bg
width="960" loading="lazy"
srcset="/images/patterns/languages/cpp-2x.png?id=75478b9701e5a44760a423402ec254b6 2x"}


![Design Patterns in
C++](/images/patterns/languages/mini/cpp.png?id=9cccd56eacf8d8685cbd0ffe598a1c4c){.dp-bg-mini
width="256" loading="lazy"
srcset="/images/patterns/languages/mini/cpp-2x.png?id=1d88a75496c5107cfb0231d9efc6ec2e 2x"}
...
[ Usage in
C++](/design-patterns/abstract-factory/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/abstract-factory/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/builder/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/builder/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/factory-method/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/factory-method/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/prototype/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/prototype/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/singleton/cpp/example#lang-features){.dp-pattern-link}
...
[ Naïve
Singleton](/design-patterns/singleton/cpp/example#example-0){.dp-pattern-link}
...
[ Thread-safe
Singleton](/design-patterns/singleton/cpp/example#example-1){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/adapter/cpp/example#lang-features){.dp-pattern-link}
...
[ Conceptual
example](/design-patterns/adapter/cpp/example#example-0){.dp-pattern-link}
...
[ Multiple
inheritance](/design-patterns/adapter/cpp/example#example-1){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/bridge/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/bridge/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/composite/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/composite/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/decorator/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/decorator/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/facade/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/facade/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/flyweight/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/flyweight/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/proxy/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/proxy/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/chain-of-responsibility/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/chain-of-responsibility/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/command/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/command/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/iterator/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/iterator/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/mediator/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/mediator/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/memento/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/memento/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/observer/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/observer/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/state/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/state/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/strategy/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/strategy/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/template-method/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/template-method/cpp/example#example-0){.dp-pattern-link}
...
[ Usage in
C++](/design-patterns/visitor/cpp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/visitor/cpp/example#example-0){.dp-pattern-link}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/design-patterns/cpp "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/design-patterns/cpp "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/design-patterns/cpp "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/design-patterns/cpp "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/design-patterns/cpp "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/design-patterns/cpp "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/design-patterns/cpp "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/design-patterns/cpp "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/design-patterns/cpp "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/design-patterns/cpp "中文"){.dropdown-item
