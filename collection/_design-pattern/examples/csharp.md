...
![Design Patterns in
C#](/images/patterns/languages/csharp.png?id=32ddb10fd07b29840082dc5337558053){.dp-bg
width="960" loading="lazy"
srcset="/images/patterns/languages/csharp-2x.png?id=d9492b7444d74abef9e912b22687a667 2x"}


![Design Patterns in
C#](/images/patterns/languages/mini/csharp.png?id=1478058bfa2905cd71379e5908efd772){.dp-bg-mini
width="256" loading="lazy"
srcset="/images/patterns/languages/mini/csharp-2x.png?id=4c800d268ad4e7d850cfd54db0f9fa9f 2x"}
...
[ Usage in
C#](/design-patterns/abstract-factory/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/abstract-factory/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/builder/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/builder/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/factory-method/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/factory-method/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/prototype/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/prototype/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/singleton/csharp/example#lang-features){.dp-pattern-link}
...
[ Naïve
Singleton](/design-patterns/singleton/csharp/example#example-0){.dp-pattern-link}
...
[ Thread-safe
Singleton](/design-patterns/singleton/csharp/example#example-1){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/adapter/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/adapter/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/bridge/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/bridge/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/composite/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/composite/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/decorator/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/decorator/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/facade/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/facade/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/flyweight/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/flyweight/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/proxy/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/proxy/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/chain-of-responsibility/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/chain-of-responsibility/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/command/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/command/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/iterator/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/iterator/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/mediator/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/mediator/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/memento/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/memento/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/observer/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/observer/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/state/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/state/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/strategy/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/strategy/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/template-method/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/template-method/csharp/example#example-0){.dp-pattern-link}
...
[ Usage in
C#](/design-patterns/visitor/csharp/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/visitor/csharp/example#example-0){.dp-pattern-link}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/design-patterns/csharp "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/design-patterns/csharp "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/design-patterns/csharp "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/design-patterns/csharp "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/design-patterns/csharp "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/design-patterns/csharp "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/design-patterns/csharp "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/design-patterns/csharp "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/design-patterns/csharp "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/design-patterns/csharp "中文"){.dropdown-item
