...
![Design Patterns in
Go](/images/patterns/languages/go.png?id=70faef6e92828d6bc0c486bc59081e22){.dp-bg
width="960" loading="lazy"
srcset="/images/patterns/languages/go-2x.png?id=aa34ed3bdda3e9e29bf73f24250a3082 2x"}


![Design Patterns in
Go](/images/patterns/languages/mini/go.png?id=4ae96539199ae1c0b15d49fccc7d84cc){.dp-bg-mini
width="256" loading="lazy"
srcset="/images/patterns/languages/mini/go-2x.png?id=3246b120fdee2b5b942c937509404f16 2x"}


# [Design]{.dp1-h-1} [Patterns]{.dp1-h-2} [in]{.dp-lang-in} [Go]{.dp-lang} {#design-patterns-in-go .dp1-h .dp-abs .dp-c .dp-h1}



## [The Catalog of ]{.dp-the-catalog}**Go** Examples {#the-catalog-of-go-examples .dp-h2}
...
[ Code
example](/design-patterns/abstract-factory/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/builder/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/factory-method/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/prototype/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/singleton/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/adapter/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/bridge/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/composite/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/decorator/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/facade/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/flyweight/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/proxy/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/chain-of-responsibility/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/command/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/iterator/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/mediator/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/memento/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/observer/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/state/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/strategy/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/template-method/go/example#example-0){.dp-pattern-link}
...
[ Code
example](/design-patterns/visitor/go/example#example-0){.dp-pattern-link}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/design-patterns/go "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/design-patterns/go "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/design-patterns/go "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/design-patterns/go "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/design-patterns/go "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/design-patterns/go "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/design-patterns/go "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/design-patterns/go "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/design-patterns/go "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/design-patterns/go "中文"){.dropdown-item
