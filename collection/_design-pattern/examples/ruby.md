...
![Design Patterns in
Ruby](/images/patterns/languages/ruby.png?id=f9f66be3c4a30f3e71a330ca61659d4c){.dp-bg
width="960" loading="lazy"
srcset="/images/patterns/languages/ruby-2x.png?id=c425b5fa22c310f9938388e812c1bcc5 2x"}


![Design Patterns in
Ruby](/images/patterns/languages/mini/ruby.png?id=587b625a9368710824fa303d29009b60){.dp-bg-mini
width="256" loading="lazy"
srcset="/images/patterns/languages/mini/ruby-2x.png?id=5ec8191a04178919fdb94adafaef2fc6 2x"}
...
[ Usage in
Ruby](/design-patterns/abstract-factory/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/abstract-factory/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/builder/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/builder/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/factory-method/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/factory-method/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/prototype/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/prototype/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/singleton/ruby/example#lang-features){.dp-pattern-link}
...
[ Naïve
Singleton](/design-patterns/singleton/ruby/example#example-0){.dp-pattern-link}
...
[ Thread-safe
Singleton](/design-patterns/singleton/ruby/example#example-1){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/adapter/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/adapter/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/bridge/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/bridge/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/composite/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/composite/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/decorator/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/decorator/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/facade/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/facade/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/flyweight/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/flyweight/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/proxy/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/proxy/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/chain-of-responsibility/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/chain-of-responsibility/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/command/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/command/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/iterator/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/iterator/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/mediator/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/mediator/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/memento/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/memento/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/observer/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/observer/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/state/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/state/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/strategy/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/strategy/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/template-method/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/template-method/ruby/example#example-0){.dp-pattern-link}
...
[ Usage in
Ruby](/design-patterns/visitor/ruby/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/visitor/ruby/example#example-0){.dp-pattern-link}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/design-patterns/ruby "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/design-patterns/ruby "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/design-patterns/ruby "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/design-patterns/ruby "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/design-patterns/ruby "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/design-patterns/ruby "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/design-patterns/ruby "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/design-patterns/ruby "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/design-patterns/ruby "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/design-patterns/ruby "中文"){.dropdown-item
