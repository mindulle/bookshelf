...
# Creational Design Patterns {#creational-design-patterns .title}
...
[[ [![Factory
Method](/images/patterns/cards/factory-method-mini.png?id=72619e9527893374b98a5913779ac167){srcset="/images/patterns/cards/factory-method-mini-2x.png?id=fa9d4a8d61a67cc3822e52b9daf69dad 2x"}]{.pattern-image}
[Factory Method]{.pattern-name} ]{.pattern-card-top} [
]{.pattern-card-bottom}](/design-patterns/factory-method){.pattern-card-extended
.factory-method}
...
[[ [![Abstract
Factory](/images/patterns/cards/abstract-factory-mini.png?id=4c3927c446313a38ce77dfee38111e27){srcset="/images/patterns/cards/abstract-factory-mini-2x.png?id=22236aaa65ff52cbde1c713216d52c1f 2x"}]{.pattern-image}
[Abstract Factory]{.pattern-name} ]{.pattern-card-top} [
]{.pattern-card-bottom}](/design-patterns/abstract-factory){.pattern-card-extended
.abstract-factory}
...
[[
[![Builder](/images/patterns/cards/builder-mini.png?id=19b95fd05e6469679752c0554b116815){srcset="/images/patterns/cards/builder-mini-2x.png?id=de6d0938678b86903a1426dddfdd13bf 2x"}]{.pattern-image}
[Builder]{.pattern-name} ]{.pattern-card-top} [
]{.pattern-card-bottom}](/design-patterns/builder){.pattern-card-extended
.builder}
...
[[
[![Prototype](/images/patterns/cards/prototype-mini.png?id=bc3046bb39ff36574c08d49839fd1c8e){srcset="/images/patterns/cards/prototype-mini-2x.png?id=b871f789a736e7efbb1cd082d2de6398 2x"}]{.pattern-image}
[Prototype]{.pattern-name} ]{.pattern-card-top} [
]{.pattern-card-bottom}](/design-patterns/prototype){.pattern-card-extended
.prototype}
...
[[
[![Singleton](/images/patterns/cards/singleton-mini.png?id=914e1565dfdf15f240e766163bd303ec){srcset="/images/patterns/cards/singleton-mini-2x.png?id=4a7348083d7719d02709a5c9ff878b9f 2x"}]{.pattern-image}
[Singleton]{.pattern-name} ]{.pattern-card-top} [
]{.pattern-card-bottom}](/design-patterns/singleton){.pattern-card-extended
.singleton}
...
[Factory Method []{.fa
.fa-arrow-right}](/design-patterns/factory-method){.btn .btn-primary
rel="next"}
...
[[]{.fa .fa-arrow-left} Catalog](/design-patterns/catalog){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/design-patterns/creational-patterns "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/design-patterns/creational-patterns "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/design-patterns/creational-patterns "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/design-patterns/creational-patterns "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/design-patterns/creational-patterns "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/design-patterns/creational-patterns "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/design-patterns/creational-patterns "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/design-patterns/creational-patterns "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/design-patterns/creational-patterns "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/design-patterns/creational-patterns "中文"){.dropdown-item
