...
[](/){.home} / [Design Patterns](/design-patterns){.type} /
[Catalog](/design-patterns/catalog){.type}


# Structural Design Patterns {#structural-design-patterns .title}
...
[[
[![Adapter](/images/patterns/cards/adapter-mini.png?id=b2ee4f681fb589be5a0685b94692aebb){srcset="/images/patterns/cards/adapter-mini-2x.png?id=8274d99afbbe9c63bfbfd0d68ceeffc7 2x"}]{.pattern-image}
[Adapter]{.pattern-name} ]{.pattern-card-top} [
]{.pattern-card-bottom}](/design-patterns/adapter){.pattern-card-extended
.adapter}

Allows objects with incompatible interfaces to collaborate.

[[
[![Bridge](/images/patterns/cards/bridge-mini.png?id=b389101d8ee8e23ffa1b534c704d0774){srcset="/images/patterns/cards/bridge-mini-2x.png?id=2622384cf623ed150ee9c21a0812dd87 2x"}]{.pattern-image}
[Bridge]{.pattern-name} ]{.pattern-card-top} [
]{.pattern-card-bottom}](/design-patterns/bridge){.pattern-card-extended
.bridge}
...
[[
[![Composite](/images/patterns/cards/composite-mini.png?id=a369d98d18b417f255d04568fd0131b8){srcset="/images/patterns/cards/composite-mini-2x.png?id=3f7f811fefeb0b64f6774746eb42af09 2x"}]{.pattern-image}
[Composite]{.pattern-name} ]{.pattern-card-top} [
]{.pattern-card-bottom}](/design-patterns/composite){.pattern-card-extended
.composite}
...
[[
[![Decorator](/images/patterns/cards/decorator-mini.png?id=d30458908e315af195cb183bc52dbef9){srcset="/images/patterns/cards/decorator-mini-2x.png?id=3b58e540d7d28523080cad341ed9b2e9 2x"}]{.pattern-image}
[Decorator]{.pattern-name} ]{.pattern-card-top} [
]{.pattern-card-bottom}](/design-patterns/decorator){.pattern-card-extended
.decorator}
...
[[
[![Facade](/images/patterns/cards/facade-mini.png?id=71ad6fa98b168c11cb3a1a9517dedf78){srcset="/images/patterns/cards/facade-mini-2x.png?id=d4cc6a5d81a31143cc665f7ac1481ac8 2x"}]{.pattern-image}
[Facade]{.pattern-name} ]{.pattern-card-top} [
]{.pattern-card-bottom}](/design-patterns/facade){.pattern-card-extended
.facade}
...
[[
[![Flyweight](/images/patterns/cards/flyweight-mini.png?id=422ca8d2f90614dce810a8812c626698){srcset="/images/patterns/cards/flyweight-mini-2x.png?id=857ca676fff84317bb0dab76abfce08e 2x"}]{.pattern-image}
[Flyweight]{.pattern-name} ]{.pattern-card-top} [
]{.pattern-card-bottom}](/design-patterns/flyweight){.pattern-card-extended
.flyweight}
...
[[
[![Proxy](/images/patterns/cards/proxy-mini.png?id=25890b11e7dc5af29625ccd0678b63a8){srcset="/images/patterns/cards/proxy-mini-2x.png?id=8638fac9dc08c992852492f9cb29d9c6 2x"}]{.pattern-image}
[Proxy]{.pattern-name} ]{.pattern-card-top} [
]{.pattern-card-bottom}](/design-patterns/proxy){.pattern-card-extended
.proxy}
...
[Adapter []{.fa .fa-arrow-right}](/design-patterns/adapter){.btn
...
[[]{.fa .fa-arrow-left} Singleton](/design-patterns/singleton){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/design-patterns/structural-patterns "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/design-patterns/structural-patterns "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/design-patterns/structural-patterns "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/design-patterns/structural-patterns "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/design-patterns/structural-patterns "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/design-patterns/structural-patterns "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/design-patterns/structural-patterns "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/design-patterns/structural-patterns "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/design-patterns/structural-patterns "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/design-patterns/structural-patterns "中文"){.dropdown-item
