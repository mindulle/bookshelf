...
# Design Patterns in **different** programming languages {#design-patterns-in-different-programming-languages .dp1-h .dp-abs .dp-c .dp-h1}




[![Design Patterns in
C#](/images/patterns/icons/csharp.svg?id=da64592defc6e86d57c39c66e9de3e58){loading="lazy"}](/design-patterns/csharp "Design Patterns in C#"){.prog-lang-link}
[![Design Patterns in
C++](/images/patterns/icons/cpp.svg?id=f7782ed8b8666246bfcc3f8fefc3b858){loading="lazy"}](/design-patterns/cpp "Design Patterns in C++"){.prog-lang-link}
[![Design Patterns in
Go](/images/patterns/icons/go.svg?id=1a89927eb99b1ea3fde7701d97970aca){loading="lazy"}](/design-patterns/go "Design Patterns in Go"){.prog-lang-link}
[![Design Patterns in
Java](/images/patterns/icons/java.svg?id=e6d87e2dca08c953fe3acd1275ed4f4e){loading="lazy"}](/design-patterns/java "Design Patterns in Java"){.prog-lang-link}
[![Design Patterns in
PHP](/images/patterns/icons/php.svg?id=be1906eb26b71ec1d3b93720d6156618){loading="lazy"}](/design-patterns/php "Design Patterns in PHP"){.prog-lang-link}
[![Design Patterns in
Python](/images/patterns/icons/python.svg?id=6d815d43c0f7050a1151b43e51569c9f){loading="lazy"}](/design-patterns/python "Design Patterns in Python"){.prog-lang-link}
[![Design Patterns in
Ruby](/images/patterns/icons/ruby.svg?id=b065b718c914bf8e960ef731600be1eb){loading="lazy"}](/design-patterns/ruby "Design Patterns in Ruby"){.prog-lang-link}
[![Design Patterns in
Rust](/images/patterns/icons/rust.svg?id=1f5698a4b5ae23fe79413511747e4a87){loading="lazy"}](/design-patterns/rust "Design Patterns in Rust"){.prog-lang-link}
[![Design Patterns in
Swift](/images/patterns/icons/swift.svg?id=0b716c2d52ec3a48fbe91ac031070c1d){loading="lazy"}](/design-patterns/swift "Design Patterns in Swift"){.prog-lang-link}
[![Design Patterns in
TypeScript](/images/patterns/icons/typescript.svg?id=2239d0f16cb703540c205dd8cb0c0cb7){loading="lazy"}](/design-patterns/typescript "Design Patterns in TypeScript"){.prog-lang-link}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/design-patterns/examples "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/design-patterns/examples "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/design-patterns/examples "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/design-patterns/examples "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/design-patterns/examples "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/design-patterns/examples "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/design-patterns/examples "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/design-patterns/examples "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/design-patterns/examples "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/design-patterns/examples "中文"){.dropdown-item
