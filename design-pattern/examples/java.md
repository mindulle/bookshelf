...
![Design Patterns in
Java](/images/patterns/languages/java.png?id=bcef5252e2f796924d3cf430bc25f5d5){.dp-bg
width="960" loading="lazy"
srcset="/images/patterns/languages/java-2x.png?id=34372503886c55fd126247165eac644f 2x"}


![Design Patterns in
Java](/images/patterns/languages/mini/java.png?id=2f6c4225c42f9da0510d8980a1639c77){.dp-bg-mini
width="256" loading="lazy"
srcset="/images/patterns/languages/mini/java-2x.png?id=7bcf912f5a5bcdd755510f8ab0f33e42 2x"}
...
[ Usage in
Java](/design-patterns/abstract-factory/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/abstract-factory/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/builder/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/builder/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/factory-method/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/factory-method/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/prototype/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/prototype/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/singleton/java/example#lang-features){.dp-pattern-link}
...
[ Naïve
Singleton](/design-patterns/singleton/java/example#example-0){.dp-pattern-link}
...
[ Thread-safe
Singleton](/design-patterns/singleton/java/example#example-2){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/adapter/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/adapter/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/bridge/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/bridge/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/composite/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/composite/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/decorator/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/decorator/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/facade/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/facade/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/flyweight/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/flyweight/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/proxy/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/proxy/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/chain-of-responsibility/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/chain-of-responsibility/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/command/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/command/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/iterator/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/iterator/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/mediator/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/mediator/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/memento/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/memento/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/observer/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/observer/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/state/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/state/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/strategy/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/strategy/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/template-method/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/template-method/java/example#example-0){.dp-pattern-link}
...
[ Usage in
Java](/design-patterns/visitor/java/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/visitor/java/example#example-0){.dp-pattern-link}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/design-patterns/java "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/design-patterns/java "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/design-patterns/java "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/design-patterns/java "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/design-patterns/java "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/design-patterns/java "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/design-patterns/java "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/design-patterns/java "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/design-patterns/java "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/design-patterns/java "中文"){.dropdown-item
