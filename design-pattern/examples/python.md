...
![Design Patterns in
Python](/images/patterns/languages/python.png?id=6f76a3e0854382007d9ee5a1b311a826){.dp-bg
width="960" loading="lazy"
srcset="/images/patterns/languages/python-2x.png?id=f8705bdca3afb0798f29dfafe75c9bd7 2x"}


![Design Patterns in
Python](/images/patterns/languages/mini/python.png?id=7513863a9ad50bcc8de3b61a926bd832){.dp-bg-mini
width="256" loading="lazy"
srcset="/images/patterns/languages/mini/python-2x.png?id=c851ebcc997357c3e77ae8f7e67ab184 2x"}
...
[ Usage in
Python](/design-patterns/abstract-factory/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/abstract-factory/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/builder/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/builder/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/factory-method/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/factory-method/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/prototype/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/prototype/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/singleton/python/example#lang-features){.dp-pattern-link}
...
[ Naïve
Singleton](/design-patterns/singleton/python/example#example-0){.dp-pattern-link}
...
[ Thread-safe
Singleton](/design-patterns/singleton/python/example#example-1){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/adapter/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/adapter/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/bridge/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/bridge/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/composite/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/composite/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/decorator/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/decorator/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/facade/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/facade/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/flyweight/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/flyweight/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/proxy/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/proxy/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/chain-of-responsibility/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/chain-of-responsibility/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/command/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/command/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/iterator/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/iterator/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/mediator/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/mediator/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/memento/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/memento/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/observer/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/observer/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/state/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/state/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/strategy/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/strategy/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/template-method/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/template-method/python/example#example-0){.dp-pattern-link}
...
[ Usage in
Python](/design-patterns/visitor/python/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/visitor/python/example#example-0){.dp-pattern-link}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/design-patterns/python "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/design-patterns/python "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/design-patterns/python "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/design-patterns/python "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/design-patterns/python "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/design-patterns/python "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/design-patterns/python "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/design-patterns/python "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/design-patterns/python "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/design-patterns/python "中文"){.dropdown-item
