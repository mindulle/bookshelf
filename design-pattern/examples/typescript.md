...
![Design Patterns in
TypeScript](/images/patterns/languages/typescript.png?id=8a56bc9bbee6cbe332781a4a2f6ef988){.dp-bg
width="960" loading="lazy"
srcset="/images/patterns/languages/typescript-2x.png?id=9bb157609ae1dbcf76c32d7a6b202428 2x"}


![Design Patterns in
TypeScript](/images/patterns/languages/mini/typescript.png?id=2553a9060e09ea9fd354b67250af4682){.dp-bg-mini
width="256" loading="lazy"
srcset="/images/patterns/languages/mini/typescript-2x.png?id=5990c3b129c17616a7a910009beb4ee9 2x"}
...
[ Usage in
TypeScript](/design-patterns/abstract-factory/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/abstract-factory/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/builder/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/builder/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/factory-method/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/factory-method/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/prototype/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/prototype/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/singleton/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/singleton/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/adapter/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/adapter/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/bridge/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/bridge/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/composite/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/composite/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/decorator/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/decorator/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/facade/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/facade/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/flyweight/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/flyweight/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/proxy/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/proxy/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/chain-of-responsibility/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/chain-of-responsibility/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/command/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/command/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/iterator/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/iterator/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/mediator/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/mediator/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/memento/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/memento/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/observer/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/observer/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/state/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/state/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/strategy/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/strategy/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/template-method/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/template-method/typescript/example#example-0){.dp-pattern-link}
...
[ Usage in
TypeScript](/design-patterns/visitor/typescript/example#lang-features){.dp-pattern-link}
...
[ Code
example](/design-patterns/visitor/typescript/example#example-0){.dp-pattern-link}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/design-patterns/typescript "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/design-patterns/typescript "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/design-patterns/typescript "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/design-patterns/typescript "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/design-patterns/typescript "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/design-patterns/typescript "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/design-patterns/typescript "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/design-patterns/typescript "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/design-patterns/typescript "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/design-patterns/typescript "中文"){.dropdown-item
